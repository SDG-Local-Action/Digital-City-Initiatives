var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'Over <b>180</b> initiatives have been documented. <br><br><b><a href="https://sdglocalaction.org/webinars/">Hear</a> from local and regional governments themselves and read their <a href="https://sdglocalaction.org/stories/">stories</a>.',
            location: 
            { 
                center: [0, 40], 
                zoom: 1, 
        ...
        },
        {
            id: 'ch3',
            alignment: 'left',
            title: 'This article documents more than 30 different digital city initiatives,',
            description: 'examining the different ways local governments are using different digital tools',
            location: 
            { 
                center: [0, 40], 
                zoom: 1.3, 
